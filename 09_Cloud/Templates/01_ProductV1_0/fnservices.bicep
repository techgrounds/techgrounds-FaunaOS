...
module appService 'fnmodules/fnappService.bicep' = if (action == 'create') {
  name: 'appService'
  params: {
    location: location
...
module deleteModule 'fnmodules/fnappService.bicep' =  if (action == 'delete') {
...
output appServiceAppHostName string = fnappService.outputs.appServiceAppHostName
