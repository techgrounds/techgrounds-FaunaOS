...
var environmentName = '${groupName}-${env}-${locationShortName}-${moduleGroup[0]}'
var resourceGroupName = 'rg-${environmentName}-${moduleGroup[0]}'
...
var vmName =  'vm-${vmOs[0]}-${env}-${locationShortName}'
